...
execute as @e[name="second",limit=1] at @e[name="second",limit=1] run fill ~-9 ~ ~-10 ~-12 ~11 ~-12 air
execute as @e[name="second",limit=1] at @e[name="second",limit=1] run fill ~-9 ~ ~10 ~-12 ~11 ~12 air
execute as @e[name="second",limit=1] at @e[name="second",limit=1] run function lager:entrance_importstation_west
