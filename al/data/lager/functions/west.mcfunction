...
execute as @e[name="first",limit=1] at @e[name="first",limit=1] run fill ~-3 ~ ~-3 ~-4 ~7 ~3 air replace stone_bricks 
execute as @e[name="first",limit=1] at @e[name="first",limit=1] run fill ~-3 ~ ~-3 ~3 ~7 ~3 air replace stone_bricks 