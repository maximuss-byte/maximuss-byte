...
execute as @e[name="second",limit=1] at @e[name="second",limit=1] run setblock ~9 ~ ~ structure_block{"name":"lager:chestunit", "mode":"LOAD", "rotation":"COUNTERCLOCKWISE_90", "posX":1, "posZ":11}
